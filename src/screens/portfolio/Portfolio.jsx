...
function Portfolio() {
  ...
  return (
    <div className="portfolio__main__container" id="portfolio">
      <h1>PORTFOLIO</h1>
      <p><DiGithubFull />
      <a href= "https://github.com/AfiaRaha" target="_blank" rel="noreferrer"> Afia Raha</a>
   </p>
      <p><FaLinkedin /> 
        <a href="https://www.linkedin.com/in/afia-munaowara-raha-8a67881b9/" target="_blank" rel="noreferrer"> Afia Munaowara Raha</a>
      </p>
